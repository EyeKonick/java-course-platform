...
import { ChevronRight, ChevronDown, FileCode, BookMarked } from 'lucide-react';

export default function Sidebar({ curriculum, activeLessonId, onSelectLesson }) {
  ...
  return (
    <aside className="w-72 flex-shrink-0 bg-slate-900 border-r border-slate-800 flex flex-col h-full overflow-hidden">
      ...
      <div className="px-5 py-6 border-b border-slate-800">
        <div className="flex items-center gap-2.5 mb-4">
          ...
          <span className="text-emerald-400 text-[10px] font-medium tracking-[0.18em] uppercase">
